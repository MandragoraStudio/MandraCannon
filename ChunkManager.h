...
public:
	...
	static int setMaxChannels(int maxNumberChannels);		// A este metodo se le pasa el numero maximo de canales que va aser 
	...
	void fadeInChunk(int loops, int ms);					// Reproduce el sonido tantas veces como se pase como argumento con un 
															// efecto de volumen ascendente
	void fadeInChunkTimed(int loops, int ms, int ticks);	// Reproduce el una parte del sonido tantas veces como se pase como argumento
															// con un efecto ascendente
	...
	void fadeOut(int ms);									// Para la reproduccion del chunk con un efecto de volumen descendente
	bool getChannelState();									// Devuelve true si el canal asociado al chunk se esta reproducciendo y 
															// false si esta en pausa
	...
	static bool getFreeChannel(int channel);				// Devuelve true si el canal pasado como argumento puede utilizarse, 
															// false si esta siendo utilizado
};
