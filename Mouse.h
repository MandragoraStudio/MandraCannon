...
protected:
	...
	MouseEvent buttonEvent;								// Estructura que guardara el ultimo evento de pulsacion o soltado 
...
public:
	...
	/*bool over(ImageManager image);						// Comprueba si el raton esta en la imagen pasada como argumento
	bool over(SpriteManager image);						// Comprueba si el raton esta en el sprite pasado como argumento
	bool over(TextManager image);						// Comprueba si el raton esta en el texto pasado como argumento
	MouseEvent getMouseEvent(SDL_Event event);			// Devuelve una estrutura tipo MouseEvent con el ultimo evento de raton
	bool overPressed(SDL_Rect rect, SDL_Event event);	// Comprueba si el ultimo evento de pulsado del raton se ha producido 
														// en el rectangulo pasado como argumento
	bool overReleased(SDL_Rect rect, SDL_Event event);	// Comprueba si el ultimo evento de soltado del raton se ha producido 
														// en el rectangulo pasado como argumento*/
